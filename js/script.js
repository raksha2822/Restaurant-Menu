...
(function (global) {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    },false); //false - bec we need to process data as string and not json
  });
  ...
  function buildCategoriesViewHtml(categories,
    ...
    // Loop over categories for menu page
  ...
  function insertItemPrice(html, pricePropName, priceValue) {
    ...
    priceValue = "$" + priceValue.toFixed(2); //2 decimal points
